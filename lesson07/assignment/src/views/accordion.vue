            ...
            <div id="accordion">
                <div class="card">
                    <div class="card-header">
                        <a href="#one" data-parent="#accordion"
                    ...
                    <div id="one" class="collapse">
                        <div class="card-body">
                            <h3 class="display-4" data-toggle="modal" data-target=".bd-example-modal-lg">Your Name</h3>
                            <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        A teenage boy and girl embark on a quest to meet each other for the<br> first time after they magically swap bodies.<br>
                                        Release date: April 7, 2017 (USA)<br>
                                        Director: Makoto Shinkai<br>
                                        Japanese: 君の名は。<br>
                                        Featured song: Zenzenzense<br>
                                        Did you know: "Your Name" is the second-highest-grossing anime film of <br>all time worldwide ($361,024,012). wikipedia.org<br>
                                    </div>
                                </div>
                            </div>
                        </div>
